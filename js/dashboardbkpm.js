...
function renderEvolucao(d) {
  ...
  new Chart(document.getElementById('dash-chart-evolucao').getContext('2d'), {
    type: 'line',
...
function renderDonutRef(d) {
  ...
  new Chart(document.getElementById('dash-chart-ref').getContext('2d'), {
    type: 'doughnut',
...
function renderDistrib(d) {
  ...
  new Chart(document.getElementById('dash-chart-distrib').getContext('2d'), {
    type: 'doughnut',
...
function renderNegDia(d) {
  ...
  new Chart(document.getElementById('dash-chart-neg-dia').getContext('2d'), {
    type: 'line',
